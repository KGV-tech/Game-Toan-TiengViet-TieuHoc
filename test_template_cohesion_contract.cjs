...
const homogeneousCases = [
    ...
    ['number.hk1_review_b01_b04', { skills: ['b01', 'b02', 'b03', 'b04'], reviewMode: 'single' }, 'skill'],
    ['number.hk1_review_b10_b15', { skills: ['b10', 'b11', 'b12', 'b13'], reviewMode: 'single' }, 'skill'],
    ['measurement.practice_cards', { allowedKinds: ['mass', 'area', 'time', 'century'] }, 'kind'],
    ['measurement.hk1_review_b17_b20', { skills: ['b17', 'b18', 'b19', 'b20'], reviewMode: 'single' }, 'skill'],
    ...
    ['number.hk1_review_b22_b25', { skills: ['b22', 'b23', 'b24', 'b25'], reviewMode: 'single' }, 'skill'],
    ['geometry.hk1_review_b27_b31', { skills: ['b27', 'b28', 'b29', 'b30'], reviewMode: 'single' }, 'skill'],
    ['number.hk1_review_b33_numbers', { skills: ['b10', 'b11', 'b12', 'b13'], reviewMode: 'single' }, 'skill'],
    ['number.hk1_review_b34_add_sub', { skills: ['b22', 'b23', 'b24', 'b25'], reviewMode: 'single' }, 'skill'],
    ['geometry.hk1_review_b35', { skills: ['b27', 'b28', 'b29', 'b30'], reviewMode: 'single' }, 'skill'],
    ['measurement.hk1_review_b36', { skills: ['b17', 'b18', 'b19', 'b20'], reviewMode: 'single' }, 'skill'],
    ['number.hk1_review_b37_full', { groups: ['numbers', 'addSub', 'geometry', 'measurement'], reviewMode: 'single' }, 'skillGroup'],
    ['g4-m-angle-review', { reviewMode: 'single' }, 'mode']
];
...
['number.hk1_review_b22_b25', 'number.hk1_review_b34_add_sub'].forEach((templateId, index) => {
    const question = generateQuestion(templateId, { skills: ['b24'], reviewMode: 'single' }, seededRandom(9400 + index));
    assertCollectionCohesion(question, 'subquestions', 'property', templateId);
});

[
    ['number.hk1_review_b01_b04', { skills: ['b02'], reviewMode: 'single' }, 'operation'],
    ['number.hk1_review_b01_b04', { skills: ['b03'], reviewMode: 'single' }, 'targetParity'],
    ['number.hk1_review_b01_b04', { skills: ['b04'], reviewMode: 'single' }, 'operation']
