    ...
    admin: {
      ...
      `;
        ...
        collectTemplateForm() {
            ...
            if (template.generator_key === 'number.safe_password_by_place_value' && (!condition1Places.length || !condition1Digits.length || !condition2Places.length || !condition2Digits.length)) throw new Error('Mỗi điều kiện mở két cần chọn ít nhất một hàng và một chữ số.');
