      ...
      `;
        ...
        templatePresets: {
                ...
                'geometry.hk1_review_b27_b31': {
                    defaultPrompt: '{question}', guide: 'Bài 32 · Tạo một lượt ôn tập hình học gồm đúng bốn kỹ năng Bài 27–Bài 31; mỗi câu con giữ nhãn Bài học.', hint: 'Chọn đúng bốn kỹ năng khác nhau để kiểm tra tỷ trọng trước khi đưa vào đề.', preview: 'live', type: 'Trắc nghiệm',
                    variables: [['{question}', 'toàn bộ bốn câu review hình học do game sinh'], ['{skills}', 'bốn kỹ năng Bài 27–Bài 31 được chọn']]
                },
                'number.hk1_review_b33_numbers': {
                    defaultPrompt: '{question}', guide: 'Bài 33 · Tạo một lượt ôn tập số học gồm đúng bốn kỹ năng về số đến lớp triệu và làm tròn.', hint: 'Chọn đúng bốn kỹ năng Bài 10–Bài 13; mỗi câu con giữ nhãn nguồn.', preview: 'live', type: 'Trắc nghiệm',
                    variables: [['{question}', 'toàn bộ bốn câu review số học do game sinh'], ['{skills}', 'bốn kỹ năng Bài 10–Bài 13 được chọn']]
                },
                'number.hk1_review_b34_add_sub': {
                    defaultPrompt: '{question}', guide: 'Bài 34 · Tạo một lượt ôn tập phép cộng và phép trừ gồm đúng bốn kỹ năng Bài 22–Bài 25.', hint: 'Chọn đúng bốn kỹ năng cộng/trừ để giữ đủ phạm vi Bài 34.', preview: 'live', type: 'Trắc nghiệm',
                    variables: [['{question}', 'toàn bộ bốn câu review cộng/trừ do game sinh'], ['{skills}', 'bốn kỹ năng Bài 22–Bài 25 được chọn']]
                },
                'geometry.hk1_review_b35': {
                    defaultPrompt: '{question}', guide: 'Bài 35 · Tạo một lượt ôn tập hình học gồm đúng bốn kỹ năng vuông góc và song song.', hint: 'Chọn đúng bốn kỹ năng Bài 27–Bài 30; hình minh họa được giữ trong câu con.', preview: 'live', type: 'Trắc nghiệm',
                    variables: [['{question}', 'toàn bộ bốn câu review hình học do game sinh'], ['{skills}', 'bốn kỹ năng Bài 27–Bài 30 được chọn']]
                },
                'measurement.hk1_review_b36': {
                    defaultPrompt: '{question}', guide: 'Bài 36 · Tạo một lượt ôn tập đo lường gồm đúng bốn kỹ năng khối lượng, diện tích, thời gian và thế kỉ.', hint: 'Chọn đúng bốn kỹ năng Bài 17–Bài 20; mỗi câu con giữ nhãn nguồn.', preview: 'live', type: 'Trắc nghiệm',
                    variables: [['{question}', 'toàn bộ bốn câu review đo lường do game sinh'], ['{skills}', 'bốn kỹ năng Bài 17–Bài 20 được chọn']]
                },
                'number.hk1_review_b37_full': {
                    defaultPrompt: '{question}', guide: 'Bài 37 · Tạo một lượt ôn tập chung Học kỳ 1 với một câu cho mỗi nhóm số học, cộng/trừ, hình học và đo lường.', hint: 'Chọn đủ bốn nhóm để giữ tỷ trọng một câu cho mỗi mảng kiến thức.', preview: 'live', type: 'Trắc nghiệm',
                    variables: [['{question}', 'toàn bộ bốn câu review chung Học kỳ 1 do game sinh'], ['{groups}', 'bốn nhóm kiến thức được chọn']]
                },
                ...
                'number.six_digit_numbers': {
                    defaultPrompt: '{question}',
                    guide: 'Bài 10 · Luyện lập và đọc số sáu chữ số, số 1 000 000 và giá trị chữ số qua bốn câu con trắc nghiệm.',
                    hint: 'Dùng <code>{question}</code> để giữ nguyên bốn câu con Bài 10 do game sinh.',
                    preview: 'live', type: 'Trắc nghiệm',
                    variables: [['{question}', 'toàn bộ bốn câu lập/đọc số sáu chữ số do game sinh'], ['{modes}', 'các dạng kỹ năng của bốn câu con']]
                },
                'number.million_class': {
                    defaultPrompt: '{question}',
                    guide: 'Bài 12 · Đọc, viết và phân tích số trong phạm vi lớp triệu; số 0 giữa các lớp được giữ rõ ràng.',
                    hint: 'Dùng <code>{question}</code> để giữ nguyên bốn câu con lớp triệu do game sinh.',
                    preview: 'live', type: 'Trắc nghiệm',
                    variables: [['{question}', 'toàn bộ bốn câu đọc/viết/phân tích số lớp triệu do game sinh'], ['{modes}', 'các dạng kỹ năng của bốn câu con']]
                },
                'number.round_hundred_thousands': {
                    defaultPrompt: '{question}',
                    guide: 'Bài 13 · Làm tròn số đến hàng trăm nghìn và chọn đúng quy tắc dựa trên chữ số hàng chục nghìn.',
                    hint: 'Dùng <code>{question}</code> để giữ nguyên bốn câu làm tròn do game sinh.',
                    preview: 'live', type: 'Trắc nghiệm',
                    variables: [['{question}', 'toàn bộ bốn câu làm tròn và quy tắc do game sinh'], ['{modes}', 'các dạng kỹ năng của bốn câu con']]
                },
                'number.hk1_review_b10_b15': {
                    defaultPrompt: '{question}',
                    guide: 'Bài 16 · Ôn tập Bài 10–15 theo bốn kỹ năng được chọn; từng câu con giữ nhãn Bài học để kiểm tra tỷ trọng.',
                    hint: 'Dùng <code>{question}</code> để giữ nguyên bộ ôn tập do game sinh.',
                    preview: 'live', type: 'Trắc nghiệm',
                    variables: [['{question}', 'toàn bộ bốn câu review Bài 10–15 do game sinh'], ['{skills}', 'bốn kỹ năng được chọn cho template']]
                },
                ...
                'measurement.practice_cards': {
                    defaultPrompt: '{question}',
                    guide: 'Bài 20 · Tạo bốn phiếu đo thực hành về khối lượng, diện tích, thời gian hoặc thế kỉ. Dữ liệu và đáp án được sinh mới ở mỗi lượt.',
                    hint: 'Dùng <code>{question}</code> để giữ nguyên bốn phiếu đo và các phương án do game sinh.',
                    preview: 'live', type: 'Trắc nghiệm',
                    variables: [['{question}', 'toàn bộ bốn phiếu đo và phương án do game sinh'], ['{kinds}', 'các nhóm đơn vị thực hành được chọn']]
                },
                'measurement.hk1_review_b17_b20': {
                    defaultPrompt: '{question}',
                    guide: 'Bài 21 · Ôn tập khối lượng, diện tích, giây/thế kỉ và thực hành. Mỗi câu con giữ nhãn Bài học để kiểm tra đủ bốn kỹ năng.',
                    hint: 'Dùng <code>{question}</code> để giữ nguyên bốn câu review có nhãn kỹ năng.',
                    preview: 'live', type: 'Trắc nghiệm',
                    variables: [['{question}', 'toàn bộ bốn câu review đo lường do game sinh'], ['{skills}', 'bốn kỹ năng Bài 17–20 được chọn']]
                },
        ...
        renderTemplatePreview(generator) {
            ...
            if (generator === 'measurement.practice_cards') return preview('Thực hành đọc phiếu đo:', `<div class="template-preview__mc">${[
                ['Khối lượng trên phiếu cân: 2 tấn 5 tạ = ? kg', ['2 050', '2 500', '2 550', '2 750']],
                ['Phiếu đo ghi 6 m² = ? dm²', ['60', '600', '6 000', '60 000']],
                ['Đồng hồ ghi 2 phút 15 giây = ? giây', ['120', '125', '135', '145']],
                ['Năm 1945 thuộc thế kỉ nào?', ['XVIII', 'XIX', 'XX', 'XXI']]
            ].map(([prompt, values], index) => `<div><b>${'abcd'[index]})</b>${prompt}${choices(values)}</div>`).join('')}</div>`, 'template-preview--multiple-choice');
            if (generator === 'measurement.hk1_review_b17_b20') return preview('Luyện tập chung Bài 17–20:', `<div class="template-preview__mc">${[
                ['Bài 17 · 7 tạ = ? kg', ['70', '700', '7 000', '70 000']],
                ['Bài 18 · 4 m² = ? dm²', ['40', '400', '4 000', '40 000']],
            ...
            if (generator === 'geometry.hk1_review_b27_b31') return preview('Luyện tập chung Bài 27 đến Bài 31:', `<div class="template-preview__mc">${['Bài 27 · Nhận biết vuông góc', 'Bài 28 · Thực hành vuông góc', 'Bài 29 · Nhận biết song song', 'Bài 31 · Hình bình hành, hình thoi'].map((prompt, index) => `<div><b>${'abcd'[index]})</b><span class="template-preview__geometry-placeholder" aria-hidden="true">◇</span>${prompt}${choices(index === 2 ? ['Song song', 'Không song song'] : index === 3 ? ['Hình bình hành', 'Hình thoi', 'Cả hai', 'Không phải cả hai'] : ['Vuông góc', 'Không vuông góc'])}</div>`).join('')}</div>`, 'template-preview--multiple-choice');
            if (generator === 'number.hk1_review_b33_numbers') return preview('Luyện tập chung Bài 33:', `<div class="template-preview__mc">${['Bài 10 · Lập số sáu chữ số', 'Bài 11 · Hàng và lớp', 'Bài 12 · Lớp triệu', 'Bài 13 · Làm tròn'].map((prompt, index) => `<div><b>${'abcd'[index]})</b>${prompt}${choices(index === 1 ? ['0', '3', '5', '8'] : ['125 000', '215 000', '512 000', '521 000'])}</div>`).join('')}</div>`, 'template-preview--multiple-choice');
            if (generator === 'number.hk1_review_b34_add_sub') return preview('Luyện tập chung Bài 34:', `<div class="template-preview__mc">${['Bài 22 · Phép cộng', 'Bài 23 · Phép trừ', 'Bài 24 · Tính chất phép cộng', 'Bài 25 · Tổng và hiệu'].map((prompt, index) => `<div><b>${'abcd'[index]})</b>${prompt}${choices(['37 000', '38 000', '39 000', '40 000'])}</div>`).join('')}</div>`, 'template-preview--multiple-choice');
            if (generator === 'geometry.hk1_review_b35') return preview('Luyện tập chung Bài 35:', `<div class="template-preview__mc">${['Bài 27 · Vuông góc', 'Bài 28 · Vuông góc trên lưới', 'Bài 29 · Song song', 'Bài 30 · Song song trên lưới'].map((prompt, index) => `<div><b>${'abcd'[index]})</b><span class="template-preview__geometry-placeholder" aria-hidden="true">╱ ╲</span>${prompt}${choices(index > 1 ? ['Song song', 'Không song song'] : ['Vuông góc', 'Không vuông góc'])}</div>`).join('')}</div>`, 'template-preview--multiple-choice');
            if (generator === 'measurement.hk1_review_b36') return preview('Luyện tập chung Bài 36:', `<div class="template-preview__mc">${['Bài 17 · Khối lượng', 'Bài 18 · Diện tích', 'Bài 19 · Thời gian', 'Bài 20 · Thế kỉ'].map((prompt, index) => `<div><b>${'abcd'[index]})</b>${prompt}${choices(['70', '700', '7 000', '70 000'])}</div>`).join('')}</div>`, 'template-preview--multiple-choice');
            if (generator === 'number.hk1_review_b37_full') return preview('Luyện tập chung Học kỳ 1:', `<div class="template-preview__mc">${['Bài 33 · Số và lớp triệu', 'Bài 34 · Cộng và trừ', 'Bài 35 · Hình học', 'Bài 36 · Đo lường'].map((prompt, index) => `<div><b>${'abcd'[index]})</b>${prompt}${choices(index === 2 ? ['Vuông góc', 'Không vuông góc'] : ['125', '250', '375', '500'])}</div>`).join('')}</div>`, 'template-preview--multiple-choice');
        ...
        collectTemplateForm() {
            ...
            if (isPhase4Review && (phase4Skills.length !== 4 || new Set(phase4Skills).size !== 4 || phase4Skills.some(skill => !['b10', 'b11', 'b12', 'b13', 'b14', 'b15'].includes(skill)))) {
                throw new Error('Bộ ôn tập Bài 10 đến Bài 15 cần chọn đúng bốn kỹ năng khác nhau.');
            }
            ...
            if (isPhase7Review && (phase7ReviewSkills.length !== 4 || new Set(phase7ReviewSkills).size !== 4 || phase7ReviewSkills.some(skill => !['b27', 'b28', 'b29', 'b30', 'b31'].includes(skill)))) {
                throw new Error('Bộ ôn tập Bài 27 đến Bài 31 cần chọn đúng bốn kỹ năng khác nhau.');
            }
            if (isPhase8FullReview && (phase8ReviewGroups.length !== 4 || new Set(phase8ReviewGroups).size !== 4 || phase8ReviewGroups.some(group => !['numbers', 'addSub', 'geometry', 'measurement'].includes(group)))) {
                throw new Error('Bài 37 cần chọn đúng bốn nhóm kiến thức HK1.');
            }
