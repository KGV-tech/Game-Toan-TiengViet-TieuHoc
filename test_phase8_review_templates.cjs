...
assert(new Set(b33.subquestions.map(item => item.skill)).size > 1);
assert(b33.subquestions.every(item => b33Skills.includes(item.skill)));
assert(b33.subquestions.every(item => item.lesson === `g4-math-hk1-${item.skill}`));
...
assert(new Set(b34.subquestions.map(item => item.skill)).size > 1);
assert(b34.subquestions.every(item => b34Skills.includes(item.skill)));
...
assert(new Set(b35.subquestions.map(item => item.skill)).size > 1);
...
assert(new Set(b36.subquestions.map(item => item.skill)).size > 1);
assert(b36.subquestions.every(item => item.lesson === `g4-math-hk1-${item.skill}`));
...
assert(new Set(b37.subquestions.map(item => item.skillGroup)).size > 1);
assert(b37.subquestions.every(item => groups.includes(item.skillGroup)));
